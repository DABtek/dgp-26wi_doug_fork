...
# Online Resources
[Canvas Site](https://canvas.evergreen.edu/courses/7979) - where to check for assignments, due dates, feedback
[GitHub Monorepo](https://github.com/TheEvergreenStateCollege/dgp-26wi/tree/main) - where to pull code for in-class practice 
[Battlecode Website]()
# Textbooks
...
[MIT's Battlecode Youtube Streams]()

# Activities and Schedule
This class will meet in two 2-hour sessions per week, on Tuesday and Thursday evenings, 6pm to 8pm Pacific Time. We will meet entirely online via Zoom, with links published to the Canvas. 

# Calendar and Activity Schedule
Classes meet on Tuesday and Thursday evenings, 6-8pm PT.

 Our first class meeting is on Tuesday, January 6th, at 6pm PT.
...
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | <br>Printing to Standard Out<br>BattleCode Intro and Runthrough<br>BattleCode Tiles <br>BattleCode Resources<br>Syllabus Review<br>Pair Programming: Driver & Navigator<br>Software Setup 1: Git and Bash for Windows, Cloning BattleCode and running scaffold | UNIX Command Line<br>BattleCode<br>Scenario: ZIP Files and Distributing Software<br>RefPlayer: Determining Furthest N,E,S,W<br>Software Setup 2: IntelliJ  |
| 2    | Objects and Types<br>Typed References, LHS and RHS<br>Enums<br>Diffs and Patches<br>Software Setup 3:                                                                                                                                                          | Instantiating New Objects<br>Class Static Members<br>Function Members (Methods)<br>Data Members (Fields)<br>Git Repositories and Local Working Directories |
| 3    | **RefPlayer Released**<br>Arrays<br>Iterators<br>Git Status                                                                                                                                                                                                    | Git Add                                                                                                                                                    |
| 4    | Generics                                                                                                                                                                                                                                                       | Git Commit                                                                                                                                                 |
| 5    |                                                                                                                                                                                                                                                                | Git Remotes and GitHub                                                                                                                                     |
| 6    |                                                                                                                                                                                                                                                                | Git Push                                                                                                                                                   |
| 7    | Git Pull (Fast-Forward)                                                                                                                                                                                                                                        | Git Pull (Merge)                                                                                                                                           |
| 8    | Strategy: Gunners vs. Pilots                                                                                                                                                                                                                                   | GitHub Pull Requests                                                                                                                                       |
| 9    |                                                                                                                                                                                                                                                                | Git-Tac-Toe                                                                                                                                                |
| 10   |                                                                                                                                                                                                                                                                |                                                                                                                                                            |
...
This undergrad research is worth a maximum of 4 credits titled "Distributed Gameplaying and Java Programming". They will be awarded if a student meets the following conditions:
* has at least 80% attendance at all class sessions
* submits 80% of homeworks
* participates in classroom discussion.
The credits will be awarded as upper division to all students on a team if that team's player beats the reference player (released in week 3) on two out of three randomly chosen maps.

Students in the class will evaluate each other at mid-term (Week 5) and at the end of the quarter (Week 10) on the basis of communication amount and style to each other and effort in designing and implementing code features. Students will be awarded credit individually, but will work on the same player source code as a team.
# Timeliness
Students will receive their evaluations by the end of Week 10 to review before a Week 11 evaluation meeting. All work will be evaluated (homeworks in Canvas, commits to git) by Friday, 5pm, Week 10.
